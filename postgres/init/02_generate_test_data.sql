-- USERS
INSERT INTO users (phone, email, first_name, last_name, patronymic, password_hash, rating, two_fa_enabled, verified, created_at) VALUES
('+79000000001', 'user1@example.com', 'Данил', 'Колбасенко', 'Бенедиктович', '$2b$12$0INxsLXfDmt0tkr9u4H28e8pWS.EtA.D7D6Ao.ZH4rUDYzuienbXG', 4.5, false, true, NOW() - INTERVAL '30 days'),
('+79000000002', 'user2@example.com', 'Игорь', 'Кожухов', 'Борисович', '$2b$12$0INxsLXfDmt0tkr9u4H28e8pWS.EtA.D7D6Ao.ZH4rUDYzuienbXG', 4.2, false, false, NOW() - INTERVAL '25 days'),
('+79000000003', 'user3@example.com', 'Лариса', 'Долина', 'Александровна', '$2b$12$0INxsLXfDmt0tkr9u4H28e8pWS.EtA.D7D6Ao.ZH4rUDYzuienbXG', 4.8, false, true, NOW() - INTERVAL '20 days'),
...
-- TRANSACTIONS
INSERT INTO transactions (user_id, type, amount, currency, status, booking_id, commission, description, gateway_transaction_id, created_at) VALUES
